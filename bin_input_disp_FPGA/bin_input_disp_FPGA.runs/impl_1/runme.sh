...
HD_PWD='D:/test/bin_input_disp_FPGA/bin_input_disp_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_module.tcl -notrace
