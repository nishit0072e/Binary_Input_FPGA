...
HD_PWD='D:/test/bin_input_disp_FPGA/bin_input_disp_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_module.tcl
